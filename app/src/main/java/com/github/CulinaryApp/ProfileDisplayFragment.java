...
public class ProfileDisplayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        profileValues = currentProfileActivity.getProfileStrings();
        imageHolder = currentProfileActivity.findViewById(R.id.images);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout content = getView().findViewById(R.id.contentContainer);

        displayName.setText(profileValues[0]);
        bio.setText(profileValues[1]);

        content.addView(bio, 0);
